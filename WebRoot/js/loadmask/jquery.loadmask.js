...
(function($) {
	...
	$.maskElement = function(element, label) {
		...
		if (label !== undefined) {
			var maskMsgDiv = $('<div id="load3"></div>');
			maskMsgDiv
					.append('<div class="load4" id="maskInfo">' + label + '</div><div class="load5"><img src="js/loadmask/images/loading.gif" width="316" height="22" /></div><div class="load4"><span class="dmg-listli-item2"> </span></div>');
