	...
	<div class="right">
		...
		<fieldset class="form form-aligned noborder">
			<div class="control-group">
	          ...
	          <input name="bankAccount.createUser" id="createUser" value=""/>
	         </div>
	        <div class="control-group">
	         <label><span style="color:red">*</span>内容</label>
	        </div>
	        <div class="control-group">
		 		<script id="content" name="bankAccount.content" type="text/plain" style="width:1024px;height:450px;"></script>
		 	</div>
		</fieldset>
		<br />	
