...
function isRightUse(name, mark, url) {
	...
	<body>
		<form action="${basePath}back/categoryAction!addCategory.action"
			method="post">
			<div id="rightcontent">
								...
								<tr>
									...
									<td class="tableitem2">
										<ld:select groupName="yesOrNoInt"
											exceptValue="${options.common.ALL}" name="category.isLeaf"
											value="${category.isLeaf}" className="dmg-select" />
									</td>
								</tr>
								<tr>
									<td width="200" class="tableitem1">
