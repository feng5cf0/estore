...
<script type="text/javascript" charset="utf-8" src="js/bankAccount/bankAccount.js?v=123"> </script>
...
<body>
	<div class="right">
		...
		<fieldset class="form form-aligned noborder">
	        ...
	        <div class="control-group">
	         <label><span style="color:red">*</span>文章标题</label>
	          <input type="text" id="title" name="technicalArticle.title"  placeholder="最大200个字符" value="${technicalArticle.title }" class="input" />
	        </div>
	        <div class="control-group">
		...
		<div align="center" style="margin-bottom: 30px">
			...
			<input class="btn-secondary btn" type="button" onclick="updateTechnicalArticle();" id="btnUpdate" value="保存" />
		</div>
		</form>
	</div>
