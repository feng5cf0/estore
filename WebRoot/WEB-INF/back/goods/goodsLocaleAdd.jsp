...
function isRightUse(name, mark, url) {
	...
	<body>
		<form action="${basePath}back/goodsLocaleAction!addGoodsLocale.action"
			method="post">
			<div id="rightcontent">
						...
						<div class="divtable">
							<table width="100%" border="0" cellspacing="1" cellpadding="0"
								...
								<tr>
									...
									<td class="tableitem3">
										<select name="goods.localeType" id="goods.localeType">
								...
								<tr>
									...
									<td class="tableitem3">
										<input type="hidden" id="goods.id" name="goods.id" value="${goods.id}"/>
								...
								<tr>
									...
									<td class="tableitem2">
										<input type="text" id="goods.goodsDescription" name="goods.goodsDescription"
											value="${goods.goodsDescription}" maxlength="20"/>
										<FONT color=red>*</FONT>
									</td>
								</tr>
								<tr>
									...
									<td class="tableitem3">
										<input type="text" id="goods.goodsPrice" name="goods.goodsPrice"
											value="${goods.goodsPrice}" maxlength="50" />
									</td>
								</tr>
							</table>
						</div>
