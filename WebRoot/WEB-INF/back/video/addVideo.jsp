...
<script type="text/javascript" charset="utf-8" src="js/video/video.js?v=1315"> </script>
	...
	<div class="right">
		...
		<fieldset class="form form-aligned noborder">
			<div class="control-group">
	          ...
	          <input type="text" id="createUser" name="video.createUser"  placeholder="30个字符" value="" class="input" />
	         </div>
	        <div class="control-group">
	         <label><span style="color:red">*</span>标题</label>
	          <input type="text" id="title" name="video.title"  placeholder="最大200个字符" value="" class="input" />
	        </div>
	        <div class="control-group">
