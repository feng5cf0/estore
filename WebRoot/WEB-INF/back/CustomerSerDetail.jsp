...
<script type="text/javascript" charset="utf-8" src="js/afterSale/customerSer.js?v=222"> </script>
	...
	<div class="right">
		...
		<fieldset class="form form-aligned noborder">
			<div class="control-group">
	          ...
	          <input readonly="readonly" type="text" id="createUser" name="customerSer.createUser"  placeholder="30个字符" value="${customerSer.createUser }" class="input" />
	         </div>
	        <div class="control-group">
	         <label><span style="color:red">*</span>QQ拥有人</label>
	          <input readonly="readonly" type="text" id="name" name="customerSer.name"  placeholder="最大200个字符" value="${customerSer.name }"  />
	        </div>
	        <div class="control-group">
	         <label><span style="color:red">*</span>qq生成的代码</label>
	         <textarea readonly="readonly" id="code" name="customerSer.qqCode" rows="15" cols="100" >${customerSer.qqCode }</textarea>
	        </div>
	        <div class="control-group">
