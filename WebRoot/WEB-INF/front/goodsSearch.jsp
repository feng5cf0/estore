...
<div class="total-con">
	...
	<div class="prolb-right prolb-right2">
		...
		<div class="procx-px">
			<span>排序：</span>
			<a class="px-txt hov" href="javascritp:getByCategory(0);">默认</a>
			<a class="px-txt" href="javascritp:getByCategory(0);">按价格</a>
			<a class="px-txt" href="javascritp:getByCategory(0);">按销量</a>
			<!--
			<div class="huanye1">
				<a class="l-jt" href="#"></a>
