...
function getMaskInfo() {
	var url = "${basePath}core/userImport!getMaskInfo.action";
	$.ajax( {
		url : url,
		type : 'post',
		data : {},
	...
	<body id="progressBar">
		<form action="${basePath}core/userImport!importUser.action"
					...
					<div class="divtable">
						<table width="100%" border="0" cellspacing="1" cellpadding="0"
							...
							<tr>
								...
								<td class="tableitem2">
									<a href="template/userImportTemplate.xls"
