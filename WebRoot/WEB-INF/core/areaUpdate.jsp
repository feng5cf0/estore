...
function checkSubmit() {
	...
	<body>
		<form action="${basePath}core/areaUpdate!updateArea.action"
			method="post">
			<div id="rightcontent">
					...
					<div class="roadbody">
						...
						<div class="divtable">
							<table width="100%" border="0" cellspacing="1" cellpadding="0"
								...
								<input type="hidden" value="${area.areaMark}"
									name="area.areaMark" />
								<input type="hidden" value="${area.creator.id}"
									name="area.creator.id" />
								<input type="hidden"
									value="<f:formatDate value="${area.createTime}" pattern="yyyy-MM-dd HH:mm:ss" />"
									name="area.createTime" />
								...
								<tr>
									...
									<td class="tableitem3">
										<input name="area.areaName" type="text" id="area.areaName"
								...
								<tr>
									...
									<td class="tableitem3">
										<textarea name="area.memo" id="area.memo" rows="5" cols="45"
