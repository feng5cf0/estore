	...
	<head>
		...
		<script type="text/javascript">
			...
			function showInfo(batchId){
				location.href("${basePath}core/ttAction!loadPayInfo.action?batch.batchId="+batchId);
			}
			...
			function importBatch(){
				window.location.href="${basePath}core/ttAction!importBatchPrepare.action";
			}
		</script>
	</head>
	<body>
		<div id="rightcontent">
			...
			<div class="roadbody1">
				<div class="roadbody">
					<div class="roadbody">
						<form action="${basePath}core/ttAction!loadTTInfo.action" onsubmit="return checkValue();" method="post">
					...
					<div class="tablebottom">
						<div class="tablebottomright">
							<form
								action="${basePath}core/ttAction!loadTTInfo.action"
								method="post" name="pagerForm" class="dmg-listli-item2">
								<input type="hidden" value="${batch.batchId }" name="batch.batchId"/>
								<input type="hidden" value="${year} }" name="year"/>
								<input type="hidden" value="${beginDate }" name="beginDate"/>
