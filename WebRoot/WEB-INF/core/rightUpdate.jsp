...
function checkSubmit(id) {
	...
	/**
	if (rightOnly(trim(rightname.value), id)) {
...
function rightOnly(rightname, id) {
	var flag = false;
...
function isRightUse(name, mark, url) {
	...
	<body>
		<form action="${basePath}core/rightUpdate!updateRight.action"
			method="post">
			<div id="rightcontent">
					...
					<div class="roadbody">
						...
						<div class="divtable">
							<table width="100%" border="0" cellspacing="1" cellpadding="0"
								...
								<input type="hidden" value="${right.id}" name="right.id" />
								<input type="hidden" value="${right.upRightId}"
									name="right.upRightId" />
								<input type="hidden" value="${right.recordOrder}"
									name="right.recordOrder" />
								<input type="hidden"
									value="<f:formatDate value="${right.createTime}" pattern="yyyy-MM-dd HH:mm:ss" />"
									name="right.createTime" />
								<input type="hidden" value="${right.creator.id}"
									name="right.creator.id" />
