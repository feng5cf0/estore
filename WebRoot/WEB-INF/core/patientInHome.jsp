...
function checkSubmit() {
	 ...
	 **/
	if (!checkData(true, "patient.bedNum", "病床号", 2, 100)) {
		return false;
	}
	if (!checkData(true, "patient.inTime", "住院日期", 2, 100)) {
		return false;
	}
	...
	<body style="overflow: auto">
		<form action="core/patient!inHome.action" method="post">
			<div id="rightcontent">
				<div id="road" class="road">
					<div class="roadItem">
						<div class="roadIcon"></div>
						<div class="roadItem2">
							您当前位置：医院管理 &gt; 病人信息管理 &gt; 病人住院
						</div>
					</div>
				</div>
				<div class="roadbody1">
						...
						<div class="divtable">
							<table width="100%" border="0" cellspacing="1" cellpadding="0"
								...
								<tr>
									...
									<td class="tableitem2">
										<input name="patient.bedNum" value="${patient.bedNum }" id="patient.bedNum"/>
										<font color=red>*</font>
								...
								<tr>
									...
									<td class="tableitem3">
										<input type="text" class="Wdate" id="patient.inTime" readonly="readonly"
											name="patient.inTime" value="<f:formatDate value="${patient.inTime }" pattern="yyyy-MM-dd"/>" maxlength="8" onfocus="WdatePicker({maxDate:'%y-%M-%d',dateFmt:'yyyy-MM-dd'});"/>
										<font color=red>*</font>
									</td>
								</tr>
								<tr>
